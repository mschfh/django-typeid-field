...
class TypeidFieldTest(TestCase):
    def test_simple(self):
        ...
        self.assertEqual(26, len(t1.id)) # default length, e.g. 2x4y6z8a0b1c2d3e4f5g6h7j8k
        self.assertEqual(30, len(t1.override)) # with prefix, e.g. pfx_2x4y6z8a0b1c2d3e4f5g6h7j8k
